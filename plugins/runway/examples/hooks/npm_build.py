#!/usr/bin/env python3
"""
CFNgin hook for building and syncing Next.js/Node.js applications to S3.

This hook builds a Next.js application and syncs the output to an S3 bucket,
with proper cache control headers for static assets and HTML files.
"""
